...
func (app *ReactAppWrapper) RegisterRoutes(router *gin.Engine) {
	...
	automationRoutes := admin.Group("automation", app.automationAvailable)
	automationRoutes.GET("rules", app.automationRules)
	automationRoutes.PUT("rules", app.automationRules)
	automationRoutes.GET("", app.listAutomations)
	automationRoutes.POST("", app.saveAutomation)
	automationRoutes.GET(":id", app.getAutomation)
	automationRoutes.PUT(":id", app.saveAutomation)
	automationRoutes.DELETE(":id", app.deleteAutomation)
	automationRoutes.POST(":id/test", app.testAutomation)
	automationRoutes.POST(":id/send", app.sendAutomation)
	automationRoutes.GET(":id/deliveries", app.automationHistory)
